...
class CodeGenCpp(CodeGenCpp):
    """
    Shared methods for CodeGen classes from :file `atoms/ehl.py`:
    and :mod `atoms.shl`: and :file `submon.py`:.
    ...
    def input_tracesets(self, formula):
        ...
        them in the same order. We use the order given by this method.

        :param formula:  the formula

        XXX: should we cache this somewhere?
        """
        set2quantifier = {}
        q2setname = {}
